...
{
    static func vectorWithRandomOrientation(magnitude magnitude : Float) -> SCNVector3
    {
        var glkVector : GLKVector3 = GLKVector3Make(magnitude, 0.0, 0.0)
        
        let zAxisRotation : GLKMatrix3 = GLKMatrix3MakeZRotation(Float.randomFrom0to1() * Float(2.0 * M_PI))
        let yAxisRotation : GLKMatrix3 = GLKMatrix3MakeYRotation(Float.randomFrom0to1() * Float(M_PI))
